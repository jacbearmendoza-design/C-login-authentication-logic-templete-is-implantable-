...
namespace Testing
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
           ...
           bool signed = false;
           Console.WriteLine("Welcome to Log into my Account game all you have to do is log into my account and you only get 5 attempts in total");
           Console.WriteLine("hint username syntax is (<jobtagabbrevation>. <type of bare metal coding language>dinary)");
           // loop
             ...
             if (string.IsNullOrEmpty(usernameinput))
                ...
                // username if statement
                 if (usernameinput == username || signed)
                 {
                    ...
                    signed = true;
                    Console.WriteLine("A hint: the password syntax is (<partialusername>Is<age>)yearsold the partial username is dr either binary or dinary you guess, and guess the age, hint hes underaged for a docter");
